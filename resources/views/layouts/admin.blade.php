    ...
    <div class="min-h-screen flex bg-muted/40">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-background border-r transition-transform duration-300 lg:static lg:translate-x-0"
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.categories.*') ? 'bg-primary text-primary-foreground shadow-md' : 'hover:bg-muted text-muted-foreground hover:text-foreground' }}">
