        ...
        <div class="bg-card p-6 rounded-xl border shadow-sm space-y-4">
            ...
            <div class="flex gap-4">
                <div class="w-24 h-16 bg-muted rounded-lg overflow-hidden flex-shrink-0">
                    <img src="{{ Str::startsWith($contract->car->image, 'http') ? $contract->car->image : Storage::url($contract->car->image) }}" class="w-full h-full object-cover">
                </div>
                <div>
        ...
        <div class="bg-card p-6 rounded-xl border shadow-sm space-y-4 md:col-span-2">
             ...
             @if($contract->deposit_image)
                <div class="rounded-xl overflow-hidden border">
                    <img src="{{ Str::startsWith($contract->deposit_image, 'http') ? $contract->deposit_image : Storage::url($contract->deposit_image) }}" class="w-full h-auto max-h-[500px] object-contain bg-black/5">
                </div>
             @else
