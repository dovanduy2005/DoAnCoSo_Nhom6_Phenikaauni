                ...
                <div class="space-y-2">
                    ...
                    @if($car->image)
                        <div class="mt-2 w-32 h-20 rounded-lg overflow-hidden border">
                            <img src="{{ Str::startsWith($car->image, 'http') ? $car->image : Storage::url($car->image) }}" class="w-full h-full object-cover">
                        </div>
                    @endif
                </div>
                        ...
                        <div class="mt-2 grid grid-cols-4 gap-2">
                            @foreach($car->images as $img)
                                <div class="relative w-full h-20 rounded-lg overflow-hidden border group">
                                    <img src="{{ Str::startsWith($img, 'http') ? $img : Storage::url($img) }}" class="w-full h-full object-cover">
