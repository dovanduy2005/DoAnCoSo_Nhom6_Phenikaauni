...
class CarSeeder extends Seeder
{
    ...
    {
        $brands = \App\Models\Brand::all()->pluck('id', 'name');
        $categories = \App\Models\Category::all()->pluck('id', 'name');

        $cars = [
            [
                'name' => 'Mercedes-Benz S-Class 2024',
                'brand_id' => $brands['Mercedes-Benz'] ?? null,
                'category_id' => $categories['Sedan'] ?? null,
                'price' => 5200000000,
                'year' => 2024,
                'type' => 'Sedan',
            ...
            [
                'name' => 'BMW X7 2024',
                'brand_id' => $brands['BMW'] ?? null,
                'category_id' => $categories['SUV'] ?? null,
                'price' => 6800000000,
                'year' => 2024,
                'type' => 'SUV',
